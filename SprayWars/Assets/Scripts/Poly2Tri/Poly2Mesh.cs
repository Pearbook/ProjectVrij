...
public static class Poly2Mesh {
	...
	public static GameObject CreateGameObject(Polygon polygon, Material mat,string name="Polygon") {
		GameObject gob = new GameObject();
		gob.name = name;
		MeshRenderer renderer = gob.AddComponent(typeof(MeshRenderer)) as MeshRenderer;
